...
if TYPE_CHECKING:
    from core.langchain_core.callbacks.base import BaseCallbackManager, Callbacks
...
def get_callback_manager_for_config(config: RunnableConfig) -> CallbackManager:
    ...
    """
    from core.langchain_core.callbacks.manager import CallbackManager
...
def get_async_callback_manager_for_config(
    ...
    """
    from core.langchain_core.callbacks.manager import AsyncCallbackManager
