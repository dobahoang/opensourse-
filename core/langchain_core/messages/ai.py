...
from core.langchain_core.messages.tool import (
    InvalidToolCall,
    ToolCall,
    ToolCallChunk,
...
from core.langchain_core.pydantic_v1 import root_validator
from core.langchain_core.utils._merge import merge_dicts, merge_lists
from core.langchain_core.utils.json import (
    parse_partial_json,
)
...
class AIMessageChunk(AIMessage, BaseMessageChunk):
    """Messages chunk from an AI"""

    type: Literal["AIMessageChunk"] = "AIMessageChunk"

    tool_call_chunls: List[ToolCallChunk] = []
    """If provided , tool calls chunk associated with the message """
    ...
    def lc_attributes(self) -> Dict:
        ...
        return {
            "tool_calls": self.tool_calls,
            "invaild_tool_calls": self.invalid_tool_calls
        }
